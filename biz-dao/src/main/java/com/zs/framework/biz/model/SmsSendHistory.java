...
public class SmsSendHistory {
     ...
     */
    @Id
    @Column(name = "sms_send_history_id")
    private Integer smsSendHistoryId;
     ...
     * 获取短信发送历史ID
     *
     * @return sms_send_history_id - 短信发送历史ID
     */
    public Integer getSmsSendHistoryId() {
        return smsSendHistoryId;
    }

    /**
     * 设置短信发送历史ID
     *
     * @param smsSendHistoryId 短信发送历史ID
     */
    public void setSmsSendHistoryId(Integer smsSendHistoryId) {
        this.smsSendHistoryId = smsSendHistoryId;
    }

    /**
     * 获取短信临时表ID
     *
     * @return sms_waiting_send_id - 短信临时表ID
     */
     ...
     * 设置短信临时表ID
     *
     * @param smsWaitingSendId 短信临时表ID
     */
