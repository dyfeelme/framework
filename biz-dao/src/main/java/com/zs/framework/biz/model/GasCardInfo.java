...
@Table(name = "gas_card_info")
public class GasCardInfo {
    /**
     * 一卡通绑定ID
     */
    @Id
    @Column(name = "gas_card_id")
     ...
     * 获取一卡通绑定ID
     *
     * @return gas_card_id - 一卡通绑定ID
     */
    public Integer getGasCardId() {
        return gasCardId;
    }
     ...
     * 设置一卡通绑定ID
     *
     * @param gasCardId 一卡通绑定ID
     */
    public void setGasCardId(Integer gasCardId) {
